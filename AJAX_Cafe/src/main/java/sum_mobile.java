...
/**
 * Servlet implementation class sum_mobile
 */
@WebServlet("/sum_mobile")
public class sum_mobile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="select rpad(b.mobile,11,'!'), sum(b.qty), sum(b.total) "
